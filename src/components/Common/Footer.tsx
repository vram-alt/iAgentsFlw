      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div className="sm:col-span-2 md:col-span-3 lg:col-span-2">
            <h3 className="font-display font-bold text-lg sm:text-xl mb-3 sm:mb-4">AgentsFlow.com</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base text-muted-foreground">
              <li><Link href="/services/assessment" className="hover:text-foreground transition-colors">Assessment</Link></li>
              <li><Link href="/services/managed-services" className="hover:text-foreground transition-colors">Managed Services</Link></li>
              <li><Link href="/services/audit-readiness" className="hover:text-foreground transition-colors">Audit Readiness</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base text-muted-foreground">
              <li><Link href="/industries/finance" className="hover:text-foreground transition-colors">Finance</Link></li>
              <li><Link href="/industries/healthcare" className="hover:text-foreground transition-colors">Healthcare</Link></li>
              <li><Link href="/industries/insurance" className="hover:text-foreground transition-colors">Insurance</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base text-muted-foreground">
              <li><Link href="/platforms/salesforce" className="hover:text-foreground transition-colors">Salesforce</Link></li>
              <li><Link href="/platforms/servicenow" className="hover:text-foreground transition-colors">ServiceNow</Link></li>
              <li><Link href="/platforms/workday" className="hover:text-foreground transition-colors">Workday</Link></li>
            </ul>
          </div>
        </div>
        <div className="grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8 mt-6 sm:mt-8">
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base text-muted-foreground">
              <li><Link href="/managed-services/guardrail-monitoring" className="hover:text-foreground transition-colors">Guardrail Monitoring</Link></li>
              <li><Link href="/managed-services/operational-checklist" className="hover:text-foreground transition-colors">Operational Checklist</Link></li>
              <li><Link href="/managed-services/data-governance" className="hover:text-foreground transition-colors">Data Governance</Link></li>
              <li><Link href="/managed-services/continuous-monitoring" className="hover:text-foreground transition-colors">Continuous Monitoring</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base text-muted-foreground">
              <li><Link href="/managed-services/spend-management" className="hover:text-foreground transition-colors">AI Spend Management</Link></li>
              <li><Link href="/managed-services/change-management" className="hover:text-foreground transition-colors">AI Change Management</Link></li>
              <li><Link href="/managed-services/audit-readiness" className="hover:text-foreground transition-colors">AI Audit Readiness</Link></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
            ...
            <ul className="flex items-center gap-3">
              ...
              <li>
                <a 
                  target="_blank" 
                  href="https://www.youtube.com/channel/UCyUcsgztVaB4bxYsvWGHW2A/" 
                  title="YouTube"
                  className="flex items-center justify-center w-10 h-10 bg-white rounded-full hover:opacity-80 transition-opacity"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className="fill-[#0e2c46]">
