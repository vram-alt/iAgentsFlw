          ...
          <div className="bg-[#0F172A]/50 backdrop-blur-md rounded-lg border border-white/10 p-6 sm:p-8 space-y-6 text-gray-300">
            <div className="space-y-8">
              ...
              <section className="border-t border-gray-700 pt-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-base leading-relaxed">
                      This includes responding to a legally binding demand for information, such as a warrant issued by a law enforcement entity of competent jurisdiction, or as reasonably necessary to preserve AgentFlow&apos;s legal rights.
                    </p>
                  </div>
                  ...
                  <div>
                    <h5 className="text-base sm:text-lg font-semibold mb-2">Does AgentFlow sell Personal Data?</h5>
                    <p className="text-base leading-relaxed">
              ...
              <section className="border-t border-gray-700 pt-6">
                ...
                <p className="text-base leading-relaxed mb-4">
                  To the fullest extent permitted by applicable law, you agree and understand that AgentFlow corp entities will not be liable for: any indirect, special, incidental, consequential, treble or other multiples of damages, exemplary or punitive damages arising from or in connection with these terms or your use of the services. AgentFlow entities are not responsible for any lost profits, lost revenues, lost business opportunities, diminution in value, including any alleged loss or diminution in value of personal information, or any other losses (collectively, &quot;losses&quot;) arising from or in connection with these terms or your use of or access to the services, including, but not limited to, losses resulting from or in connection with: the deletion of, alteration of, mis-delivery of, or failure to store data maintained or transmitted by the services; the limiting, suspension or termination of your account; your downloading or sharing of information, including personal information, via the services; the unauthorized access to your account or any data maintained or transmitted by the services; links provided by the services or third parties to external sites or resources; your dealings with or participation in promotions of advertisers found on or through the services; or any good or services sold by such advertisers. AgentFlow entities will not be liable for problems caused by others, the wrongful or unlawful actions of third parties, or an act of god. The limitations and exclusions in these terms will apply whether or not we have been advised of or should have been aware of the possibility of any losses arising.
                </p>
                <p className="text-base leading-relaxed">
                  To the fullest extent permitted by law and except as otherwise stated, AgentFlow corp entities are not liable in connection with any disputes that arise out of or relate to these terms or services for any amount greater than the amount you paid to us for the services.
                </p>
              </section>
