...
const SplitRevealHero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-16 sm:pt-20 bg-[#0A0F1A] text-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center min-h-[80vh] py-8 sm:py-12">
          ...
          >
            ...
            <motion.p 
              className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 leading-relaxed max-w-2xl mt-4 sm:mt-6 md:mt-8"
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="w-full sm:w-auto border-2 border-[#0080FF] text-[#0080FF] hover:bg-[#0080FF] hover:text-white px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 text-base sm:text-lg md:text-xl group shadow-xl bg-transparent"
          ...
          >
            <div 
              className="relative w-full h-[400px] sm:h-[450px] md:h-[500px] bg-[#172135] backdrop-blur-md border-2 border-white/20 rounded-xl sm:rounded-2xl overflow-hidden cursor-col-resize shadow-2xl"
            ...
            >
              ...
              >
                <div className="text-green-400 font-bold text-lg sm:text-xl md:text-2xl mb-4 sm:mb-6">With AgentsFlow.com</div>
              ...
              <div 
                className="absolute inset-0 bg-gradient-to-l from-red-500/30 via-red-500/20 to-transparent p-4 sm:p-6 md:p-8"
            ...
            <div className="text-center mt-4 sm:mt-6 text-xs sm:text-sm md:text-base text-gray-400 font-medium">
