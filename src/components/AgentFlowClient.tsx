      ...
      <div className="border-b border-white/5 bg-[#0F172A]/30">
        <div className="container mx-auto px-4 py-3 sm:px-6 sm:py-4">
          <div className="flex items-center space-x-2 text-xs text-gray-400 sm:text-sm">
            ...
            <span>/</span>
            <span className="text-[#F47F21]">AppsBee</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="px-2 text-base text-gray-300 sm:text-lg md:text-xl">From AI teams to compliance officers, AppsBee delivers value across your organization</p>
          </motion.div>
                ...
                <form className="space-y-6">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <label className="text-sm text-gray-300">
                      I agree to receive updates from AgentFlow.ai.
