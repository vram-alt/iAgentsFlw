...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 !bg-[#0A0F1A]/95 backdrop-blur-md border-b border-white/10 shadow-xl">
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-18 py-2">
          {/* Logo */}
          <Link href="/" className="hover:scale-105 transition-transform flex items-center">
            <SmartImage 
              src="/image/AgentFlow-logo/webp" 
              alt="AgentFlow Logo" 
              ...
              <AnimatePresence>
                {isProductsOpen && (
                  <motion.div
                    ...
                    className="absolute top-full left-0 mt-2 w-64 bg-[#0F172A]/95 backdrop-blur-md border-2 border-white/20 rounded-xl p-4 shadow-2xl z-50"
                  >
                    <Link href="/tools/appsbee" className="block p-3 rounded-lg hover:bg-white/10 transition-colors">
                      <div className="font-medium text-white">AppsBee</div>
