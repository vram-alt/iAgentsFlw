            ...
            <div className="space-y-3">
              {currentData.kpis.map((kpi, index) => (
                <motion.div
                  ...
                  className="flex items-center justify-between p-4 bg-card/60 rounded-xl border-2 border-white/20 shadow-lg"
                >
            ...
            <div className="space-y-4">
              {currentData.howWeFix.map((item, index) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                  className="flex items-start space-x-3 p-4 bg-card/30 rounded-lg border-2 border-white/20 shadow-lg"
                >
