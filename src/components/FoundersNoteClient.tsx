            ...
            <Card className="bg-[#0F172A]/50 backdrop-blur-md border-white/10">
              <CardContent className="p-8 sm:p-12">
                <div className="prose prose-invert prose-lg max-w-none space-y-3">
                  ...
                  <p className="text-gray-300 text-lg leading-snug">
                    Over the past years, we&apos;ve been on an exciting journey of transformation — evolving from our roots in enterprise software into a new chapter centered on AI-driven products that empower organizations to work smarter, faster, and more responsibly.
                  </p>
