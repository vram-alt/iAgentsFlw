          ...
          <div className="flex flex-wrap justify-center gap-6">
            {personas.map((persona) => (
              <button
                ...
                className={`px-8 py-4 rounded-full font-semibold transition-all duration-300 text-lg border-2 ${selectedPersona === persona.id
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {benefits.map((benefit, index) => (
                ...
                >
                  <Card className="glass  border border-red-600 h-full shadow-lg hover:shadow-xl transition-all">
                    <CardHeader>
