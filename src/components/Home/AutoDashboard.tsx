      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="desktop-dashboard min-h-screen">
          ...
          <div className="desktop-toolbar h-14 sm:h-16 flex items-center justify-between px-3 sm:px-6 sticky top-0 z-50">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              {/* Status Indicator */}
              <div className={`flex items-center space-x-1 sm:space-x-2 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm ${isRunning
                                ...
                                <div className="flex items-start space-x-3 flex-1">
                                  ...
                                  <div className="flex-1 min-w-0">
                                    <div className="flex items-center space-x-2 mb-1">
                                      ...
                                      <span className={`px-2 py-1 rounded text-xs font-medium ${alert.severity === 'critical' ? 'bg-red-500/30 text-red-300 border border-red-500/50' :
